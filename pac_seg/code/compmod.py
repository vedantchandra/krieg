...
def run(survey=None,tileID=None,index=None,GaiaID=None,FiberID=None,mjd=None,version='VX',verbose=False):
    # read in SEGUE data
    ...
    compmodfile = '{OUTDIR}/plots/segue_gaiaID_{GAIAID}_fibID_{FIBID}_plate_{PLATEID}_mjd_{MJD}_{VER}_compmod.png'.format(
        OUTDIR=outdir,
        FIBID=data['phot']['FIBERID'],
        GAIAID=data['phot']['GAIAEDR3_ID'],
        PLATEID=data['phot']['PLATE'],
