...
def run(survey=None,tileID=None,index=None,GaiaID=None,FiberID=None,mjd=None,version='VX'):
    ...
    samplefile = '{OUTDIR}/samples/segue_gaiaID_{GAIAID}_fibID_{FIBID}_plate_{PLATEID}_mjd_{MJD}_{VER}_samp.dat'.format(
        OUTDIR=outdir,
        FIBID=photcat['FIBERID'],
        GAIAID=photcat['GAIAEDR3_ID'],
        PLATEID=photcat['PLATE'],
        MJD=photcat['MJD'],
        VER=version)
    ...
    parstring = (
        'Run index: {} '.format(photcat['SEGUE_INDEX'])+
    ...
    cornerfile = '{OUTDIR}/plots/segue_gaiaID_{GAIAID}_fibID_{FIBID}_plate_{PLATEID}_mjd_{MJD}_{VER}_corner.png'.format(
        OUTDIR=outdir,
        FIBID=photcat['FIBERID'],
        GAIAID=photcat['GAIAEDR3_ID'],
        PLATEID=photcat['PLATE'],
